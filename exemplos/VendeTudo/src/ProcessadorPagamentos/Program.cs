...
using VendeTudo.ProcessadorPagamentos;
...
builder.Services.AdicionarBarramentoEventosRabbitMQ(config =>
{
    ...
    config.NomeFilaAssinatura = section["NomeFilaAssinatura"] ?? "processador_pagamentos_queue";
});

// Manipuladores
builder.Services.AddScoped<EstoqueConfirmadoManipulador>();

var host = builder.Build();

// Assinar eventos
var barramento = host.Services.GetRequiredService<IBarramentoEventos>();
barramento.Assinar<EstoqueConfirmadoEventoIntegracao, EstoqueConfirmadoManipulador>();
